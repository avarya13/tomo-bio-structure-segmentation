...
class SmallUnet(nn.Module):
    ...
    Attributes:
        ...
        bottle_neck (Conv): Bottleneck convolutional block.
    ...
    def __init__(self, input_channels, num_classes):
        ...
        """
        super().__init__()
        self.e1 = Encoder(input_channels, 16)
        self.e2 = Encoder(16, 32)
        self.bottle_neck = Conv(32, 64)
        self.d1 = Decoder(64, 32)
        self.d2 = Decoder(32, 16)
    ...
    def forward(self, x):
        ...
        bottle_neck = self.bottle_neck(pool_x2)  
        d1 = self.d1(bottle_neck, skip_x2) 
        d2 = self.d2(d1, skip_x1)  
